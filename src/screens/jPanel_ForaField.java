...
public class jPanel_ForaField extends javax.swing.JPanel {
    ...
    class CustomRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable tab, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            if (tab.getValueAt(row, 10).equals("") && isSelected) {

                cellComponent.setBackground(global_class.get_color(139, 0, 0));
                cellComponent.setForeground(Color.white);
                cellComponent.setFont(cellComponent.getFont().deriveFont(Font.BOLD));

            } else if (tab.getValueAt(row, 10).equals("") && !isSelected) {
    ...
    public jPanel_ForaField(scr_Menu Menu00, String tipo_ativ, String perfil) {
        initComponents();
        ...
        if (ativ.equals("GARANTIA")) {
            ...
            Menu01.garantia_panel_forafield = this;

        } else if (ativ.equals("POOL")) {

            Menu01.pool_panel_forafield = this;

        } else if (ativ.equals("POOL_HFC")) {

            Menu01.pool_panel_foraactivia = this;

        } else if (ativ.equals("POOL_DESCO")) {

            Menu01.pool_desco_panel_forafield = this;

        } else if (ativ.equals("GPON")) {

            Menu01.gpon_pool_panel_forafield = this;

        }

    }

    public jPanel_ForaField(scr_Menu Menu00, String tipo_ativ, String perfil, boolean foraactivia) {
        initComponents();
    ...
    public jPanel_ForaField(scr_Menu Menu00, String tipo_ativ, boolean foraactiviadth, String perfil) {
        initComponents();
    ...
    public void combo_cidade() {
        ...
        global_class.preencher_combobox(combo_cidades_ff, "-- Selecione uma cidade --", "CALL workstation_bcc.app_cidades_ff3('" + ativ + "')");
                ...
                if (!global_class.check_version()) {
                    ...
                    if (isselectedrow > 0) {
                        ...
                        for (int z = 0; z < rows_select.length; z++) {
                            ...
                            if (tableFF.getValueAt(rows_select[z], 10).equals("")) {
                        ...
                        jMenuUN.setText("Associar Equipe");
                            ...
                            public void actionPerformed(ActionEvent ae) {
                                ...
                                switch (ativ) {
                                    case "GARANTIA": {
                                        ...
                                        jDialog_Definir_Equipe definir = new jDialog_Definir_Equipe(true, Menu01, ids_select, cidade_selecionada, ativ, Menu01.garantia_panel_forafield);
                                        break;
                                    }
                                    case "POOL": {
                                        //jDialog_Definir_Equipe definir = new jDialog_Definir_Equipe(true, Menu01, ids_select, nomes_uns_field, Menu01.pool_panel_forafield);
                                        jDialog_Definir_Equipe definir = new jDialog_Definir_Equipe(true, Menu01, ids_select, cidade_selecionada, ativ, Menu01.pool_panel_forafield);
                                        break;
                                    }
                                    case "POOL_HFC": {
                                        //jDialog_Definir_Equipe definir = new jDialog_Definir_Equipe(true, Menu01, ids_select, nomes_uns_field, Menu01.pool_panel_foraactivia);
                                        jDialog_Definir_Equipe definir = new jDialog_Definir_Equipe(true, Menu01, ids_select, cidade_selecionada, ativ, Menu01.pool_panel_foraactivia);
                                        break;
                                    }
                                    case "POOL_DESCO": {
                                        //jDialog_Definir_Equipe definir = new jDialog_Definir_Equipe(true, Menu01, ids_select, nomes_uns_field, Menu01.pool_desco_panel_forafield);
                                        jDialog_Definir_Equipe definir = new jDialog_Definir_Equipe(true, Menu01, ids_select, cidade_selecionada, ativ, Menu01.pool_desco_panel_forafield);
                                        break;
                                    }
                                    case "GPON": {
                                        jDialog_Definir_Equipe definir = new jDialog_Definir_Equipe(true, Menu01, ids_select, cidade_selecionada, ativ, Menu01.gpon_pool_panel_forafield);
                                        break;
                                    }
                                    default:
                                        break;
                ...
                if (!global_class.check_version()) {
                    ...
                    if (row_select >= 0) { //a primeira linha de dados é a 0 (zero)
                        ...
                        if (tableSuper.getValueAt(row_select, 12).equals("OK") && !tableSuper.getValueAt(row_select, 8).equals("")) {
                            ...
                            jMenuReturn.addActionListener(new jPanel_ForaField.action_return(id_caso));
    ...
    public void casos_email(int num, String ids) {
        ...
        try {
            ...
            table_casos = global_class.getTable("CALL workstation_bcc.app_casos_tratados_un_ff6('" + cidade_selecionada + "','" + uns_email.get(num) + "','" + ativ + "', '" + ids + "')");
